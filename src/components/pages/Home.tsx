...
function Home() {
  ...
  (currentOfficeInformationData.canRegisterLunch ? {linkAddress: `${import.meta.env.VITE_BASE_URL_PATH ? import.meta.env.VITE_BASE_URL_PATH : ""}/slack-auth?previousLocation=${import.meta.env.VITE_BASE_URL_PATH ? import.meta.env.VITE_BASE_URL_PATH : ""}/office-details/lunch`, title:"Lunch", description:"Sign up for Lunch"} : {}),
